...
class EnglishLink12b extends StatefulWidget {
  const EnglishLink12b({Key? key}) : super(key: key);

  @override
  _EnglishLink12bState createState() => _EnglishLink12bState();
}

class _EnglishLink12bState extends State<EnglishLink12b> {
  late String link;
  late String id;
  late String pass;
