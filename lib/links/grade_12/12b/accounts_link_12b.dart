...
class AccountsLink12b extends StatefulWidget {
  const AccountsLink12b({Key? key}) : super(key: key);

  @override
  AccountsLink12bState createState() => AccountsLink12bState();
}

class AccountsLink12bState extends State<AccountsLink12b> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 12B - Accounts", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
