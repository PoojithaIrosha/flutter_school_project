...
class EnglishLink12c extends StatefulWidget {
  const EnglishLink12c({Key? key}) : super(key: key);

  @override
  _EnglishLink12cState createState() => _EnglishLink12cState();
}

class _EnglishLink12cState extends State<EnglishLink12c> {
  late String link;
  late String id;
  late String pass;
