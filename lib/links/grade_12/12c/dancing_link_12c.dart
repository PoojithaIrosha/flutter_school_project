...
class DancingLink12c extends StatefulWidget {
  const DancingLink12c({Key? key}) : super(key: key);

  @override
  DancingLink12cState createState() => DancingLink12cState();
}

class DancingLink12cState extends State<DancingLink12c> {
  late String link;
  late String id;
  late String pass;
