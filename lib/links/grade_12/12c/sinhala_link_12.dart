...
class SinhalaLink12c extends StatefulWidget {
  const SinhalaLink12c({Key? key}) : super(key: key);

  @override
  _SinhalaLink12cState createState() => _SinhalaLink12cState();
}

class _SinhalaLink12cState extends State<SinhalaLink12c> {
  late String link;
  late String id;
  late String pass;
