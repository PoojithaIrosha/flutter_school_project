...
class BioLink12a extends StatefulWidget {
  const BioLink12a({Key? key}) : super(key: key);

  @override
  BioLink12aState createState() => BioLink12aState();
}

class BioLink12aState extends State<BioLink12a> {
  late String link;
  late String id;
  late String pass;
