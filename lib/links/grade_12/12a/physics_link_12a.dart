...
class PhysicsLink12a extends StatefulWidget {
  const PhysicsLink12a({Key? key}) : super(key: key);

  @override
  PhysicsLink12aState createState() => PhysicsLink12aState();
}

class PhysicsLink12aState extends State<PhysicsLink12a> {
  late String link;
  late String id;
  late String pass;
