...
class MathsLink9b extends StatefulWidget {
  const MathsLink9b({Key? key}) : super(key: key);

  @override
  _MathsLink9bState createState() => _MathsLink9bState();
}

class _MathsLink9bState extends State<MathsLink9b> {
  late String link;
  late String id;
  late String pass;
