...
class SinhalaLink9b extends StatefulWidget {
  const SinhalaLink9b({Key? key}) : super(key: key);

  @override
  _SinhalaLink9bState createState() => _SinhalaLink9bState();
}

class _SinhalaLink9bState extends State<SinhalaLink9b> {
  late String link;
  late String id;
  late String pass;
