...
class GeoLink9b extends StatefulWidget {
  const GeoLink9b({Key? key}) : super(key: key);

  @override
  _GeoLink9bState createState() => _GeoLink9bState();
}

class _GeoLink9bState extends State<GeoLink9b> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 9B - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
