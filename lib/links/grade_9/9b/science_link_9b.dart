...
class ScienceLink9b extends StatefulWidget {
  const ScienceLink9b({Key? key}) : super(key: key);

  @override
  _ScienceLink9bState createState() => _ScienceLink9bState();
}

class _ScienceLink9bState extends State<ScienceLink9b> {
  late String link;
  late String id;
  late String pass;
