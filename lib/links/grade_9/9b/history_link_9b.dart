...
class HistoryLink9b extends StatefulWidget {
  const HistoryLink9b({Key? key}) : super(key: key);

  @override
  _HistoryLink9bState createState() => _HistoryLink9bState();
}

class _HistoryLink9bState extends State<HistoryLink9b> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      // Change Here
                      "You have class on every Friday from 6.00PM to 7.30PM",
                      style: TextStyle(
                          fontSize: 25,
                          fontFamily: 'Caveat',
