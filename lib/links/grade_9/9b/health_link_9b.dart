...
class HealthLink9b extends StatefulWidget {
  const HealthLink9b({Key? key}) : super(key: key);

  @override
  _HealthLink9bState createState() => _HealthLink9bState();
}

class _HealthLink9bState extends State<HealthLink9b> {
  late String link;
  late String id;
  late String pass;
