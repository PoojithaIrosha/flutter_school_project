...
class BuddhismLink9b extends StatefulWidget {
  const BuddhismLink9b({Key? key}) : super(key: key);

  @override
  _BuddhismLink9bState createState() => _BuddhismLink9bState();
}

class _BuddhismLink9bState extends State<BuddhismLink9b> {
  late String link;
  late String id;
  late String pass;
