...
class PtsLink9b extends StatefulWidget {
  const PtsLink9b({Key? key}) : super(key: key);

  @override
  _PtsLink9bState createState() => _PtsLink9bState();
}

class _PtsLink9bState extends State<PtsLink9b> {
  late String link;
  late String id;
  late String pass;
