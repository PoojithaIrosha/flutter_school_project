...
class EnglishLink9b extends StatefulWidget {
  const EnglishLink9b({Key? key}) : super(key: key);

  @override
  _EnglishLink9bState createState() => _EnglishLink9bState();
}

class _EnglishLink9bState extends State<EnglishLink9b> {
  late String link;
  late String id;
  late String pass;
