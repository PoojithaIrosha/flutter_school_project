...
class DancingLink9 extends StatefulWidget {
  const DancingLink9({Key? key}) : super(key: key);

  @override
  _DancingLink9State createState() => _DancingLink9State();
}

class _DancingLink9State extends State<DancingLink9> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      // Change Here
                      "You have class on every Monday from 6.00AM to 7.30AM",
                      style: TextStyle(
                          fontSize: 25,
                          fontFamily: 'Caveat',
