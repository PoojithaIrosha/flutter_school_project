...
class MusicLink9 extends StatefulWidget {
  const MusicLink9({Key? key}) : super(key: key);

  @override
  _MusicLink9State createState() => _MusicLink9State();
}

class _MusicLink9State extends State<MusicLink9> {
  late String link;
  late String id;
  late String pass;
