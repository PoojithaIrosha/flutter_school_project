...
class DramaLink9 extends StatefulWidget {
  const DramaLink9({Key? key}) : super(key: key);

  @override
  _DramaLink9State createState() => _DramaLink9State();
}

class _DramaLink9State extends State<DramaLink9> {
  late String link;
  late String id;
  late String pass;
