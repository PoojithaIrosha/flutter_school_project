...
class ArtLink9 extends StatefulWidget {
  const ArtLink9({Key? key}) : super(key: key);

  @override
  _ArtLink9State createState() => _ArtLink9State();
}

class _ArtLink9State extends State<ArtLink9> {
  late String link;
  late String id;
  late String pass;
