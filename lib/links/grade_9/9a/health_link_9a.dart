...
class HealthLink9a extends StatefulWidget {
  const HealthLink9a({Key? key}) : super(key: key);

  @override
  _HealthLink9aState createState() => _HealthLink9aState();
}

class _HealthLink9aState extends State<HealthLink9a> {
  late String link;
  late String id;
  late String pass;
