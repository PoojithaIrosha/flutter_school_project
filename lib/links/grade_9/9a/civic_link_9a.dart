...
class CivicLink9a extends StatefulWidget {
  const CivicLink9a({Key? key}) : super(key: key);

  @override
  _CivicLink9aState createState() => _CivicLink9aState();
}

class _CivicLink9aState extends State<CivicLink9a> {
  late String link;
  late String id;
  late String pass;
