...
class ScienceLink9a extends StatefulWidget {
  const ScienceLink9a({Key? key}) : super(key: key);

  @override
  _ScienceLink9aState createState() => _ScienceLink9aState();
}

class _ScienceLink9aState extends State<ScienceLink9a> {
  late String link;
  late String id;
  late String pass;
