...
class SinhalaLink9a extends StatefulWidget {
  const SinhalaLink9a({Key? key}) : super(key: key);

  @override
  _SinhalaLink9aState createState() => _SinhalaLink9aState();
}

class _SinhalaLink9aState extends State<SinhalaLink9a> {
  late String link;
  late String id;
  late String pass;
