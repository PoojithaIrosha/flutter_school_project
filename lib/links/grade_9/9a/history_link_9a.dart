...
class HistoryLink9a extends StatefulWidget {
  const HistoryLink9a({Key? key}) : super(key: key);

  @override
  _HistoryLink9aState createState() => _HistoryLink9aState();
}

class _HistoryLink9aState extends State<HistoryLink9a> {
  late String link;
  late String id;
  late String pass;
