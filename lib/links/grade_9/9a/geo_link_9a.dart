...
class GeoLink9a extends StatefulWidget {
  const GeoLink9a({Key? key}) : super(key: key);

  @override
  _GeoLink9aState createState() => _GeoLink9aState();
}

class _GeoLink9aState extends State<GeoLink9a> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 9A - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
