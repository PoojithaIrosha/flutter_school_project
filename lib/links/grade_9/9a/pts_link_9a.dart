...
class PtsLink9a extends StatefulWidget {
  const PtsLink9a({Key? key}) : super(key: key);

  @override
  _PtsLink9aState createState() => _PtsLink9aState();
}

class _PtsLink9aState extends State<PtsLink9a> {
  late String link;
  late String id;
  late String pass;
