...
class BuddhismLink9a extends StatefulWidget {
  const BuddhismLink9a({Key? key}) : super(key: key);

  @override
  _BuddhismLink9aState createState() => _BuddhismLink9aState();
}

class _BuddhismLink9aState extends State<BuddhismLink9a> {
  late String link;
  late String id;
  late String pass;
