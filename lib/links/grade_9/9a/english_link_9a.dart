...
class EnglishLink9a extends StatefulWidget {
  const EnglishLink9a({Key? key}) : super(key: key);

  @override
  _EnglishLink9aState createState() => _EnglishLink9aState();
}

class _EnglishLink9aState extends State<EnglishLink9a> {
  late String link;
  late String id;
  late String pass;
