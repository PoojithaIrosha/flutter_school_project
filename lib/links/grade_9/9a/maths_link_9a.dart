...
class MathsLink9a extends StatefulWidget {
  const MathsLink9a({Key? key}) : super(key: key);

  @override
  _MathsLink9aState createState() => _MathsLink9aState();
}

class _MathsLink9aState extends State<MathsLink9a> {
  late String link;
  late String id;
  late String pass;
