...
class HealthLink9c extends StatefulWidget {
  const HealthLink9c({Key? key}) : super(key: key);

  @override
  _HealthLink9cState createState() => _HealthLink9cState();
}

class _HealthLink9cState extends State<HealthLink9c> {
  late String link;
  late String id;
  late String pass;
