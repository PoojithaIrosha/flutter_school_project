...
class ScienceLink9c extends StatefulWidget {
  const ScienceLink9c({Key? key}) : super(key: key);

  @override
  _ScienceLink9cState createState() => _ScienceLink9cState();
}

class _ScienceLink9cState extends State<ScienceLink9c> {
  late String link;
  late String id;
  late String pass;
