...
class SinhalaLink9c extends StatefulWidget {
  const SinhalaLink9c({Key? key}) : super(key: key);

  @override
  _SinhalaLink9cState createState() => _SinhalaLink9cState();
}

class _SinhalaLink9cState extends State<SinhalaLink9c> {
  late String link;
  late String id;
  late String pass;
