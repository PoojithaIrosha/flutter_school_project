...
class CivicLink9c extends StatefulWidget {
  const CivicLink9c({Key? key}) : super(key: key);

  @override
  _CivicLink9cState createState() => _CivicLink9cState();
}

class _CivicLink9cState extends State<CivicLink9c> {
  late String link;
  late String id;
  late String pass;
