...
class EnglishLink9c extends StatefulWidget {
  const EnglishLink9c({Key? key}) : super(key: key);

  @override
  _EnglishLink9cState createState() => _EnglishLink9cState();
}

class _EnglishLink9cState extends State<EnglishLink9c> {
  late String link;
  late String id;
  late String pass;
