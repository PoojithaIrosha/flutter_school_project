...
class MathsLink9c extends StatefulWidget {
  const MathsLink9c({Key? key}) : super(key: key);

  @override
  _MathsLink9cState createState() => _MathsLink9cState();
}

class _MathsLink9cState extends State<MathsLink9c> {
  late String link;
  late String id;
  late String pass;
