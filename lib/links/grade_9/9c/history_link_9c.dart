...
class HistoryLink9c extends StatefulWidget {
  const HistoryLink9c({Key? key}) : super(key: key);

  @override
  _HistoryLink9cState createState() => _HistoryLink9cState();
}

class _HistoryLink9cState extends State<HistoryLink9c> {
  late String link;
  late String id;
  late String pass;
