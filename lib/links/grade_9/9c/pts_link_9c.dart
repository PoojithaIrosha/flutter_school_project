...
class PtsLink9c extends StatefulWidget {
  const PtsLink9c({Key? key}) : super(key: key);

  @override
  _PtsLink9cState createState() => _PtsLink9cState();
}

class _PtsLink9cState extends State<PtsLink9c> {
  late String link;
  late String id;
  late String pass;
