...
class EnglishLink8a extends StatefulWidget {
  const EnglishLink8a({Key? key}) : super(key: key);

  @override
  _EnglishLink8aState createState() => _EnglishLink8aState();
}

class _EnglishLink8aState extends State<EnglishLink8a> {
  late String link;
  late String id;
  late String pass;
