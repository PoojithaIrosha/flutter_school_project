...
class CivicLink8a extends StatefulWidget {
  const CivicLink8a({Key? key}) : super(key: key);

  @override
  _CivicLink8aState createState() => _CivicLink8aState();
}

class _CivicLink8aState extends State<CivicLink8a> {
  late String link;
  late String id;
  late String pass;
