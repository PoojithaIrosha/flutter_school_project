...
class SinhalaLink8a extends StatefulWidget {
  const SinhalaLink8a({Key? key}) : super(key: key);

  @override
  _SinhalaLink8aState createState() => _SinhalaLink8aState();
}

class _SinhalaLink8aState extends State<SinhalaLink8a> {
  late String link;
  late String id;
  late String pass;
