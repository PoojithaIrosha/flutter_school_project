...
class GeoLink8a extends StatefulWidget {
  const GeoLink8a({Key? key}) : super(key: key);

  @override
  _GeoLink8aState createState() => _GeoLink8aState();
}

class _GeoLink8aState extends State<GeoLink8a> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 8A - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
