...
class HealthLink8a extends StatefulWidget {
  const HealthLink8a({Key? key}) : super(key: key);

  @override
  _HealthLink8aState createState() => _HealthLink8aState();
}

class _HealthLink8aState extends State<HealthLink8a> {
  late String link;
  late String id;
  late String pass;
