...
class ScienceLink8a extends StatefulWidget {
  const ScienceLink8a({Key? key}) : super(key: key);

  @override
  _ScienceLink8aState createState() => _ScienceLink8aState();
}

class _ScienceLink8aState extends State<ScienceLink8a> {
  late String link;
  late String id;
  late String pass;
