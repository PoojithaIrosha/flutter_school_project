...
class MathsLink8a extends StatefulWidget {
  const MathsLink8a({Key? key}) : super(key: key);

  @override
  _MathsLink8aState createState() => _MathsLink8aState();
}

class _MathsLink8aState extends State<MathsLink8a> {
  late String link;
  late String id;
  late String pass;
