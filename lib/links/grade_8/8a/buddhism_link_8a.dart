...
class BuddhismLink8a extends StatefulWidget {
  const BuddhismLink8a({Key? key}) : super(key: key);

  @override
  _BuddhismLink8aState createState() => _BuddhismLink8aState();
}

class _BuddhismLink8aState extends State<BuddhismLink8a> {
  late String link;
  late String id;
  late String pass;
