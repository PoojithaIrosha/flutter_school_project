...
class HistoryLink8a extends StatefulWidget {
  const HistoryLink8a({Key? key}) : super(key: key);

  @override
  _HistoryLink8aState createState() => _HistoryLink8aState();
}

class _HistoryLink8aState extends State<HistoryLink8a> {
  late String link;
  late String id;
  late String pass;
