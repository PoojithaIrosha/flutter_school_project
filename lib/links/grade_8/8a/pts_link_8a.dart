...
class PtsLink8a extends StatefulWidget {
  const PtsLink8a({Key? key}) : super(key: key);

  @override
  _PtsLink8aState createState() => _PtsLink8aState();
}

class _PtsLink8aState extends State<PtsLink8a> {
  late String link;
  late String id;
  late String pass;
