...
class ScienceLink8b extends StatefulWidget {
  const ScienceLink8b({Key? key}) : super(key: key);

  @override
  _ScienceLink8bState createState() => _ScienceLink8bState();
}

class _ScienceLink8bState extends State<ScienceLink8b> {
  late String link;
  late String id;
  late String pass;
