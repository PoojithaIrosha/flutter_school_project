...
class PtsLink8b extends StatefulWidget {
  const PtsLink8b({Key? key}) : super(key: key);

  @override
  _PtsLink8bState createState() => _PtsLink8bState();
}

class _PtsLink8bState extends State<PtsLink8b> {
  late String link;
  late String id;
  late String pass;
