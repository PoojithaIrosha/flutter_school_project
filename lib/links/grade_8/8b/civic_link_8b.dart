...
class CivicLink8b extends StatefulWidget {
  const CivicLink8b({Key? key}) : super(key: key);

  @override
  _CivicLink8bState createState() => _CivicLink8bState();
}

class _CivicLink8bState extends State<CivicLink8b> {
  late String link;
  late String id;
  late String pass;
