...
class BuddhismLink8b extends StatefulWidget {
  const BuddhismLink8b({Key? key}) : super(key: key);

  @override
  _BuddhismLink8bState createState() => _BuddhismLink8bState();
}

class _BuddhismLink8bState extends State<BuddhismLink8b> {
  late String link;
  late String id;
  late String pass;
