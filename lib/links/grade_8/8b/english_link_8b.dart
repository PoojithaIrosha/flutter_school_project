...
class EnglishLink8b extends StatefulWidget {
  const EnglishLink8b({Key? key}) : super(key: key);

  @override
  _EnglishLink8bState createState() => _EnglishLink8bState();
}

class _EnglishLink8bState extends State<EnglishLink8b> {
  late String link;
  late String id;
  late String pass;
