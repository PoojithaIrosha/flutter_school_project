...
class MathsLink8b extends StatefulWidget {
  const MathsLink8b({Key? key}) : super(key: key);

  @override
  _MathsLink8bState createState() => _MathsLink8bState();
}

class _MathsLink8bState extends State<MathsLink8b> {
  late String link;
  late String id;
  late String pass;
