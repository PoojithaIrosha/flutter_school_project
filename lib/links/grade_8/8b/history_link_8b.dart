...
class HistoryLink8b extends StatefulWidget {
  const HistoryLink8b({Key? key}) : super(key: key);

  @override
  _HistoryLink8bState createState() => _HistoryLink8bState();
}

class _HistoryLink8bState extends State<HistoryLink8b> {
  late String link;
  late String id;
  late String pass;
