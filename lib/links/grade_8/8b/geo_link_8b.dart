...
class GeoLink8b extends StatefulWidget {
  const GeoLink8b({Key? key}) : super(key: key);

  @override
  _GeoLink8bState createState() => _GeoLink8bState();
}

class _GeoLink8bState extends State<GeoLink8b> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 8B - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
