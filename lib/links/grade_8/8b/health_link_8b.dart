...
class HealthLink8b extends StatefulWidget {
  const HealthLink8b({Key? key}) : super(key: key);

  @override
  _HealthLink8bState createState() => _HealthLink8bState();
}

class _HealthLink8bState extends State<HealthLink8b> {
  late String link;
  late String id;
  late String pass;
