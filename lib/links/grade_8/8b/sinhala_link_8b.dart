...
class SinhalaLink8b extends StatefulWidget {
  const SinhalaLink8b({Key? key}) : super(key: key);

  @override
  _SinhalaLink8bState createState() => _SinhalaLink8bState();
}

class _SinhalaLink8bState extends State<SinhalaLink8b> {
  late String link;
  late String id;
  late String pass;
