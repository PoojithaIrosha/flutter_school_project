...
class MusicLink8 extends StatefulWidget {
  const MusicLink8({Key? key}) : super(key: key);

  @override
  _MusicLink8State createState() => _MusicLink8State();
}

class _MusicLink8State extends State<MusicLink8> {
  late String link;
  late String id;
  late String pass;
