...
class DramaLink8 extends StatefulWidget {
  const DramaLink8({Key? key}) : super(key: key);

  @override
  _DramaLink8State createState() => _DramaLink8State();
}

class _DramaLink8State extends State<DramaLink8> {
  late String link;
  late String id;
  late String pass;
