...
class DancingLink8 extends StatefulWidget {
  const DancingLink8({Key? key}) : super(key: key);

  @override
  _DancingLink8State createState() => _DancingLink8State();
}

class _DancingLink8State extends State<DancingLink8> {
  late String link;
  late String id;
  late String pass;
