...
class ArtLink8 extends StatefulWidget {
  const ArtLink8({Key? key}) : super(key: key);

  @override
  _ArtLink8State createState() => _ArtLink8State();
}

class _ArtLink8State extends State<ArtLink8> {
  late String link;
  late String id;
  late String pass;
