...
class CivicLink8c extends StatefulWidget {
  const CivicLink8c({Key? key}) : super(key: key);

  @override
  _CivicLink8cState createState() => _CivicLink8cState();
}

class _CivicLink8cState extends State<CivicLink8c> {
  late String link;
  late String id;
  late String pass;
