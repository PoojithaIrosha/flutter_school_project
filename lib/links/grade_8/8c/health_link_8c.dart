...
class HealthLink8c extends StatefulWidget {
  const HealthLink8c({Key? key}) : super(key: key);

  @override
  _HealthLink8cState createState() => _HealthLink8cState();
}

class _HealthLink8cState extends State<HealthLink8c> {
  late String link;
  late String id;
  late String pass;
