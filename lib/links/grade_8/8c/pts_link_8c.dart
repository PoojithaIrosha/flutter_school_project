...
class PtsLink8c extends StatefulWidget {
  const PtsLink8c({Key? key}) : super(key: key);

  @override
  _PtsLink8cState createState() => _PtsLink8cState();
}

class _PtsLink8cState extends State<PtsLink8c> {
  late String link;
  late String id;
  late String pass;
