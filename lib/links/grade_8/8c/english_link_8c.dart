...
class EnglishLink8c extends StatefulWidget {
  const EnglishLink8c({Key? key}) : super(key: key);

  @override
  _EnglishLink8cState createState() => _EnglishLink8cState();
}

class _EnglishLink8cState extends State<EnglishLink8c> {
  late String link;
  late String id;
  late String pass;
