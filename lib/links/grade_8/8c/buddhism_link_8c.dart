...
class BuddhismLink8c extends StatefulWidget {
  const BuddhismLink8c({Key? key}) : super(key: key);

  @override
  _BuddhismLink8cState createState() => _BuddhismLink8cState();
}

class _BuddhismLink8cState extends State<BuddhismLink8c> {
  late String link;
  late String id;
  late String pass;
