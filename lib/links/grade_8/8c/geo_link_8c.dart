...
class GeoLink8c extends StatefulWidget {
  const GeoLink8c({Key? key}) : super(key: key);

  @override
  _GeoLink8cState createState() => _GeoLink8cState();
}

class _GeoLink8cState extends State<GeoLink8c> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 8C - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
