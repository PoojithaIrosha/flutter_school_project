...
class HistoryLink8c extends StatefulWidget {
  const HistoryLink8c({Key? key}) : super(key: key);

  @override
  _HistoryLink8cState createState() => _HistoryLink8cState();
}

class _HistoryLink8cState extends State<HistoryLink8c> {
  late String link;
  late String id;
  late String pass;
