...
class MathsLink8c extends StatefulWidget {
  const MathsLink8c({Key? key}) : super(key: key);

  @override
  _MathsLink8cState createState() => _MathsLink8cState();
}

class _MathsLink8cState extends State<MathsLink8c> {
  late String link;
  late String id;
  late String pass;
