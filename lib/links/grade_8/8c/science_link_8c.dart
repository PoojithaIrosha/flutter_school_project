...
class ScienceLink8c extends StatefulWidget {
  const ScienceLink8c({Key? key}) : super(key: key);

  @override
  _ScienceLink8cState createState() => _ScienceLink8cState();
}

class _ScienceLink8cState extends State<ScienceLink8c> {
  late String link;
  late String id;
  late String pass;
