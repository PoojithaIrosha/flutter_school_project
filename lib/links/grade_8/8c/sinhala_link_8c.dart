...
class SinhalaLink8c extends StatefulWidget {
  const SinhalaLink8c({Key? key}) : super(key: key);

  @override
  _SinhalaLink8cState createState() => _SinhalaLink8cState();
}

class _SinhalaLink8cState extends State<SinhalaLink8c> {
  late String link;
  late String id;
  late String pass;
