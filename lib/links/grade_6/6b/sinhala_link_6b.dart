...
class SinhalaLink6b extends StatefulWidget {
  const SinhalaLink6b({Key? key}) : super(key: key);

  @override
  _SinhalaLink6bState createState() => _SinhalaLink6bState();
}

class _SinhalaLink6bState extends State<SinhalaLink6b> {
  late String link;
  late String id;
  late String pass;
