...
class EnglishLink6b extends StatefulWidget {
  const EnglishLink6b({Key? key}) : super(key: key);

  @override
  _EnglishLink6bState createState() => _EnglishLink6bState();
}

class _EnglishLink6bState extends State<EnglishLink6b> {
  late String link;
  late String id;
  late String pass;
