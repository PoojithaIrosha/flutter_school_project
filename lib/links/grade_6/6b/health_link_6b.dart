...
class HealthLink6b extends StatefulWidget {
  const HealthLink6b({Key? key}) : super(key: key);

  @override
  _HealthLink6bState createState() => _HealthLink6bState();
}

class _HealthLink6bState extends State<HealthLink6b> {
  late String link;
  late String id;
  late String pass;
