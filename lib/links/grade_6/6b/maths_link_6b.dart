...
class MathsLink6b extends StatefulWidget {
  const MathsLink6b({Key? key}) : super(key: key);

  @override
  _MathsLink6bState createState() => _MathsLink6bState();
}

class _MathsLink6bState extends State<MathsLink6b> {
  late String link;
  late String id;
  late String pass;
