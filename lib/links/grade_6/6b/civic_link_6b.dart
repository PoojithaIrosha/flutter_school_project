...
class CivicLink6b extends StatefulWidget {
  const CivicLink6b({Key? key}) : super(key: key);

  @override
  _CivicLink6bState createState() => _CivicLink6bState();
}

class _CivicLink6bState extends State<CivicLink6b> {
  late String link;
  late String id;
  late String pass;
