...
class GeoLink6b extends StatefulWidget {
  const GeoLink6b({Key? key}) : super(key: key);

  @override
  _GeoLink6bState createState() => _GeoLink6bState();
}

class _GeoLink6bState extends State<GeoLink6b> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 6B - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
