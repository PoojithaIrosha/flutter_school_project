...
class BuddhismLink6b extends StatefulWidget {
  const BuddhismLink6b({Key? key}) : super(key: key);

  @override
  _BuddhismLink6bState createState() => _BuddhismLink6bState();
}

class _BuddhismLink6bState extends State<BuddhismLink6b> {
  late String link;
  late String id;
  late String pass;
