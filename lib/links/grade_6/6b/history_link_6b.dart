...
class HistoryLink6b extends StatefulWidget {
  const HistoryLink6b({Key? key}) : super(key: key);

  @override
  _HistoryLink6bState createState() => _HistoryLink6bState();
}

class _HistoryLink6bState extends State<HistoryLink6b> {
  late String link;
  late String id;
  late String pass;
