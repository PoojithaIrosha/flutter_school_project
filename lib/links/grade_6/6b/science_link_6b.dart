...
class ScienceLink6b extends StatefulWidget {
  const ScienceLink6b({Key? key}) : super(key: key);

  @override
  _ScienceLink6bState createState() => _ScienceLink6bState();
}

class _ScienceLink6bState extends State<ScienceLink6b> {
  late String link;
  late String id;
  late String pass;
