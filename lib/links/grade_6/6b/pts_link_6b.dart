...
class PtsLink6b extends StatefulWidget {
  const PtsLink6b({Key? key}) : super(key: key);

  @override
  _PtsLink6bState createState() => _PtsLink6bState();
}

class _PtsLink6bState extends State<PtsLink6b> {
  late String link;
  late String id;
  late String pass;
