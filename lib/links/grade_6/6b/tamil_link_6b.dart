...
class TamilLink6b extends StatefulWidget {
  const TamilLink6b({Key? key}) : super(key: key);

  @override
  _TamilLink6bState createState() => _TamilLink6bState();
}

class _TamilLink6bState extends State<TamilLink6b> {
  late String link;
  late String id;
  late String pass;
