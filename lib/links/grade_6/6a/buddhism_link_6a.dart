...
class BuddhismLink6a extends StatefulWidget {
  const BuddhismLink6a({Key? key}) : super(key: key);

  @override
  _BuddhismLink6aState createState() => _BuddhismLink6aState();
}

class _BuddhismLink6aState extends State<BuddhismLink6a> {
  late String link;
  late String id;
  late String pass;
