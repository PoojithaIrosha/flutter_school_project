...
class ScienceLink6a extends StatefulWidget {
  const ScienceLink6a({Key? key}) : super(key: key);

  @override
  _ScienceLink6aState createState() => _ScienceLink6aState();
}

class _ScienceLink6aState extends State<ScienceLink6a> {
  late String link;
  late String id;
  late String pass;
