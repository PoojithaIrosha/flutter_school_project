...
class SinhalaLink6a extends StatefulWidget {
  const SinhalaLink6a({Key? key}) : super(key: key);

  @override
  _SinhalaLink6aState createState() => _SinhalaLink6aState();
}

class _SinhalaLink6aState extends State<SinhalaLink6a> {
  late String link;
  late String id;
  late String pass;
