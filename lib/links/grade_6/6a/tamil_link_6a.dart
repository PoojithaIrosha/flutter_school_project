...
class TamilLink6a extends StatefulWidget {
  const TamilLink6a({Key? key}) : super(key: key);

  @override
  _TamilLink6aState createState() => _TamilLink6aState();
}

class _TamilLink6aState extends State<TamilLink6a> {
  late String link;
  late String id;
  late String pass;
