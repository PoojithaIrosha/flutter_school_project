...
class PtsLink6a extends StatefulWidget {
  const PtsLink6a({Key? key}) : super(key: key);

  @override
  _PtsLink6aState createState() => _PtsLink6aState();
}

class _PtsLink6aState extends State<PtsLink6a> {
  late String link;
  late String id;
  late String pass;
