...
class MathsLink6a extends StatefulWidget {
  const MathsLink6a({Key? key}) : super(key: key);

  @override
  _MathsLink6aState createState() => _MathsLink6aState();
}

class _MathsLink6aState extends State<MathsLink6a> {
  late String link;
  late String id;
  late String pass;
