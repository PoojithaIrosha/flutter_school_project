...
class HealthLink6a extends StatefulWidget {
  const HealthLink6a({Key? key}) : super(key: key);

  @override
  _HealthLink6aState createState() => _HealthLink6aState();
}

class _HealthLink6aState extends State<HealthLink6a> {
  late String link;
  late String id;
  late String pass;
