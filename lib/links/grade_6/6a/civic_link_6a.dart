...
class CivicLink6a extends StatefulWidget {
  const CivicLink6a({Key? key}) : super(key: key);

  @override
  _CivicLink6aState createState() => _CivicLink6aState();
}

class _CivicLink6aState extends State<CivicLink6a> {
  late String link;
  late String id;
  late String pass;
