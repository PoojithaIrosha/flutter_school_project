...
class HistoryLink6a extends StatefulWidget {
  const HistoryLink6a({Key? key}) : super(key: key);

  @override
  _HistoryLink6aState createState() => _HistoryLink6aState();
}

class _HistoryLink6aState extends State<HistoryLink6a> {
  late String link;
  late String id;
  late String pass;
