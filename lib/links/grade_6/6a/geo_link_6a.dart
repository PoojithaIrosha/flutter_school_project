...
class GeoLink6a extends StatefulWidget {
  const GeoLink6a({Key? key}) : super(key: key);

  @override
  _GeoLink6aState createState() => _GeoLink6aState();
}

class _GeoLink6aState extends State<GeoLink6a> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 6A - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
