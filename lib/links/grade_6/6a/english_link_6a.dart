...
class EnglishLink6a extends StatefulWidget {
  const EnglishLink6a({Key? key}) : super(key: key);

  @override
  _EnglishLink6aState createState() => _EnglishLink6aState();
}

class _EnglishLink6aState extends State<EnglishLink6a> {
  late String link;
  late String id;
  late String pass;
