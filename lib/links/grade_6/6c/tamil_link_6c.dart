...
class TamilLink6c extends StatefulWidget {
  const TamilLink6c({Key? key}) : super(key: key);

  @override
  _TamilLink6cState createState() => _TamilLink6cState();
}

class _TamilLink6cState extends State<TamilLink6c> {
  late String link;
  late String id;
  late String pass;
