...
class EnglishLink6c extends StatefulWidget {
  const EnglishLink6c({Key? key}) : super(key: key);

  @override
  _EnglishLink6cState createState() => _EnglishLink6cState();
}

class _EnglishLink6cState extends State<EnglishLink6c> {
  late String link;
  late String id;
  late String pass;
