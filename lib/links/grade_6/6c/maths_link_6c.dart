...
class MathsLink6c extends StatefulWidget {
  const MathsLink6c({Key? key}) : super(key: key);

  @override
  _MathsLink6cState createState() => _MathsLink6cState();
}

class _MathsLink6cState extends State<MathsLink6c> {
  late String link;
  late String id;
  late String pass;
