...
class HealthLink6c extends StatefulWidget {
  const HealthLink6c({Key? key}) : super(key: key);

  @override
  _HealthLink6cState createState() => _HealthLink6cState();
}

class _HealthLink6cState extends State<HealthLink6c> {
  late String link;
  late String id;
  late String pass;
