...
class CivicLink6c extends StatefulWidget {
  const CivicLink6c({Key? key}) : super(key: key);

  @override
  _CivicLink6cState createState() => _CivicLink6cState();
}

class _CivicLink6cState extends State<CivicLink6c> {
  late String link;
  late String id;
  late String pass;
