...
class SinhalaLink6c extends StatefulWidget {
  const SinhalaLink6c({Key? key}) : super(key: key);

  @override
  _SinhalaLink6cState createState() => _SinhalaLink6cState();
}

class _SinhalaLink6cState extends State<SinhalaLink6c> {
  late String link;
  late String id;
  late String pass;
