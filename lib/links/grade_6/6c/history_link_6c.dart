...
class HistoryLink6c extends StatefulWidget {
  const HistoryLink6c({Key? key}) : super(key: key);

  @override
  _HistoryLink6cState createState() => _HistoryLink6cState();
}

class _HistoryLink6cState extends State<HistoryLink6c> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      // Change Here
                      "You have class on every Tuesday from 6.00PM to 7.30PM",
                      style: TextStyle(
                          fontSize: 25,
                          fontFamily: 'Caveat',
