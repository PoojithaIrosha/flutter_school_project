...
class GeoLink6c extends StatefulWidget {
  const GeoLink6c({Key? key}) : super(key: key);

  @override
  _GeoLink6cState createState() => _GeoLink6cState();
}

class _GeoLink6cState extends State<GeoLink6c> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 6C - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
