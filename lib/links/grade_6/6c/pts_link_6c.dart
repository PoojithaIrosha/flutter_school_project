...
class PtsLink6c extends StatefulWidget {
  const PtsLink6c({Key? key}) : super(key: key);

  @override
  _PtsLink6cState createState() => _PtsLink6cState();
}

class _PtsLink6cState extends State<PtsLink6c> {
  late String link;
  late String id;
  late String pass;
