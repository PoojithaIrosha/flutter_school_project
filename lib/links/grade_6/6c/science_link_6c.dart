...
class ScienceLink6c extends StatefulWidget {
  const ScienceLink6c({Key? key}) : super(key: key);

  @override
  _ScienceLink6cState createState() => _ScienceLink6cState();
}

class _ScienceLink6cState extends State<ScienceLink6c> {
  late String link;
  late String id;
  late String pass;
