...
class BuddhismLink6c extends StatefulWidget {
  const BuddhismLink6c({Key? key}) : super(key: key);

  @override
  _BuddhismLink6cState createState() => _BuddhismLink6cState();
}

class _BuddhismLink6cState extends State<BuddhismLink6c> {
  late String link;
  late String id;
  late String pass;
