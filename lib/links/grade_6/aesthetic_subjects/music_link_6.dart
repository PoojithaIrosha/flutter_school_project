...
class MusicLink6 extends StatefulWidget {
  const MusicLink6({Key? key}) : super(key: key);

  @override
  _MusicLink6State createState() => _MusicLink6State();
}

class _MusicLink6State extends State<MusicLink6> {
  late String link;
  late String id;
  late String pass;
