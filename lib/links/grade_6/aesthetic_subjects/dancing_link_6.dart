...
class DancingLink6 extends StatefulWidget {
  const DancingLink6({Key? key}) : super(key: key);

  @override
  _DancingLink6State createState() => _DancingLink6State();
}

class _DancingLink6State extends State<DancingLink6> {
  late String link;
  late String id;
  late String pass;
