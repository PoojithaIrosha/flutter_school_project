...
class ArtLink6 extends StatefulWidget {
  const ArtLink6({Key? key}) : super(key: key);

  @override
  _ArtLink6State createState() => _ArtLink6State();
}

class _ArtLink6State extends State<ArtLink6> {
  late String link;
  late String id;
  late String pass;
