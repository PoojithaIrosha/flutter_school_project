...
class DramaLink6 extends StatefulWidget {
  const DramaLink6({Key? key}) : super(key: key);

  @override
  _DramaLink6State createState() => _DramaLink6State();
}

class _DramaLink6State extends State<DramaLink6> {
  late String link;
  late String id;
  late String pass;
