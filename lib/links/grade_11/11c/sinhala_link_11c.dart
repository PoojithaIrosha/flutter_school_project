...
class SinhalaLink11c extends StatefulWidget {
  const SinhalaLink11c({Key? key}) : super(key: key);

  @override
  _SinhalaLink11cState createState() => _SinhalaLink11cState();
}

class _SinhalaLink11cState extends State<SinhalaLink11c> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      // Change Here
                      "You have class on every Tuesday from 6.00AM to 7.30AM",
                      style: TextStyle(
                          fontSize: 25,
                          fontFamily: 'Caveat',
