...
class BuddhismLink11c extends StatefulWidget {
  const BuddhismLink11c({Key? key}) : super(key: key);

  @override
  _BuddhismLink11cState createState() => _BuddhismLink11cState();
}

class _BuddhismLink11cState extends State<BuddhismLink11c> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 11C - Buddhism", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
