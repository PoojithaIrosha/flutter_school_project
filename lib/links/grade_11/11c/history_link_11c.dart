...
class HistoryLink11c extends StatefulWidget {
  const HistoryLink11c({Key? key}) : super(key: key);

  @override
  _HistoryLink11cState createState() => _HistoryLink11cState();
}

class _HistoryLink11cState extends State<HistoryLink11c> {
  late String link;
  late String id;
  late String pass;
