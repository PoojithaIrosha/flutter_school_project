...
class MathsLink11c extends StatefulWidget {
  const MathsLink11c({Key? key}) : super(key: key);

  @override
  _MathsLink11cState createState() => _MathsLink11cState();
}

class _MathsLink11cState extends State<MathsLink11c> {
  late String link;
  late String id;
  late String pass;
