...
class ScienceLink11c extends StatefulWidget {
  const ScienceLink11c({Key? key}) : super(key: key);

  @override
  _ScienceLink11cState createState() => _ScienceLink11cState();
}

class _ScienceLink11cState extends State<ScienceLink11c> {
  late String link;
  late String id;
  late String pass;
