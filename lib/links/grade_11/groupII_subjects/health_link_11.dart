...
class HealthLink11 extends StatefulWidget {
  const HealthLink11({Key? key}) : super(key: key);

  @override
  _HealthLink11State createState() => _HealthLink11State();
}

class _HealthLink11State extends State<HealthLink11> {
  late String link;
  late String id;
  late String pass;
