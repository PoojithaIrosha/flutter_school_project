...
class ICTLink11 extends StatefulWidget {
  const ICTLink11({Key? key}) : super(key: key);

  @override
  _ICTLink11 createState() => _ICTLink11();
}

class _ICTLink11 extends State<ICTLink11> {
  late String link;
  late String id;
  late String pass;
