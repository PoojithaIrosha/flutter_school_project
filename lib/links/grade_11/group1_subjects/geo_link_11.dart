...
class GeoLink11 extends StatefulWidget {
  const GeoLink11({Key? key}) : super(key: key);

  @override
  _GeoLink11State createState() => _GeoLink11State();
}

class _GeoLink11State extends State<GeoLink11> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 11 - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
