...
class CivicLink11 extends StatefulWidget {
  const CivicLink11({Key? key}) : super(key: key);

  @override
  _CivicLink11State createState() => _CivicLink11State();
}

class _CivicLink11State extends State<CivicLink11> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 11 - Civic Education", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
