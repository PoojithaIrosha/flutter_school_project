...
class MathsLink11a extends StatefulWidget {
  const MathsLink11a({Key? key}) : super(key: key);

  @override
  _MathsLink11aState createState() => _MathsLink11aState();
}

class _MathsLink11aState extends State<MathsLink11a> {
  late String link;
  late String id;
  late String pass;
