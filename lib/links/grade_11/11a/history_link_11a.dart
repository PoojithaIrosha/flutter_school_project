...
class HistoryLink11a extends StatefulWidget {
  const HistoryLink11a({Key? key}) : super(key: key);

  @override
  _HistoryLink11aState createState() => _HistoryLink11aState();
}

class _HistoryLink11aState extends State<HistoryLink11a> {
  late String link;
  late String id;
  late String pass;
