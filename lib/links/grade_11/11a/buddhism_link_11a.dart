...
class BuddhismLink11a extends StatefulWidget {
  const BuddhismLink11a({Key? key}) : super(key: key);

  @override
  _BuddhismLink11aState createState() => _BuddhismLink11aState();
}

class _BuddhismLink11aState extends State<BuddhismLink11a> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 11A - Buddhism", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
