...
class EnglishLink11a extends StatefulWidget {
  const EnglishLink11a({Key? key}) : super(key: key);

  @override
  _EnglishLink11aState createState() => _EnglishLink11aState();
}

class _EnglishLink11aState extends State<EnglishLink11a> {
  late String link;
  late String id;
  late String pass;
