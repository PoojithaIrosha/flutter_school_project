...
class SinhalaLink11a extends StatefulWidget {
  const SinhalaLink11a({Key? key}) : super(key: key);

  @override
  _SinhalaLink11aState createState() => _SinhalaLink11aState();
}

class _SinhalaLink11aState extends State<SinhalaLink11a> {
  late String link;
  late String id;
  late String pass;
