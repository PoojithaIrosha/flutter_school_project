...
class ScienceLink11a extends StatefulWidget {
  const ScienceLink11a({Key? key}) : super(key: key);

  @override
  _ScienceLink11aState createState() => _ScienceLink11aState();
}

class _ScienceLink11aState extends State<ScienceLink11a> {
  late String link;
  late String id;
  late String pass;
