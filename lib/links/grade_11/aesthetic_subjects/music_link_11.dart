...
class MusicLink11 extends StatefulWidget {
  const MusicLink11({Key? key}) : super(key: key);

  @override
  _MusicLink11State createState() => _MusicLink11State();
}

class _MusicLink11State extends State<MusicLink11> {
  late String link;
  late String id;
  late String pass;
