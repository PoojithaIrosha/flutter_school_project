...
class ArtLink11 extends StatefulWidget {
  const ArtLink11({Key? key}) : super(key: key);

  @override
  _ArtLink11State createState() => _ArtLink11State();
}

class _ArtLink11State extends State<ArtLink11> {
  late String link;
  late String id;
  late String pass;
