...
class DramaLink11 extends StatefulWidget {
  const DramaLink11({Key? key}) : super(key: key);

  @override
  _DramaLink11State createState() => _DramaLink11State();
}

class _DramaLink11State extends State<DramaLink11> {
  late String link;
  late String id;
  late String pass;
