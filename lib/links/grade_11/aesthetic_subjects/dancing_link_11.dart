...
class DancingLink11 extends StatefulWidget {
  const DancingLink11({Key? key}) : super(key: key);

  @override
  _DancingLink11State createState() => _DancingLink11State();
}

class _DancingLink11State extends State<DancingLink11> {
  late String link;
  late String id;
  late String pass;
