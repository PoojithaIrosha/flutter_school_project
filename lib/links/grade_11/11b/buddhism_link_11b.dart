...
class BuddhismLink11b extends StatefulWidget {
  const BuddhismLink11b({Key? key}) : super(key: key);

  @override
  _BuddhismLink11bState createState() => _BuddhismLink11bState();
}

class _BuddhismLink11bState extends State<BuddhismLink11b> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 11B - Buddhism", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
