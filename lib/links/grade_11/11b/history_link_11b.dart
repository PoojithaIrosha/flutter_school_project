...
class HistoryLink11b extends StatefulWidget {
  const HistoryLink11b({Key? key}) : super(key: key);

  @override
  _HistoryLink11bState createState() => _HistoryLink11bState();
}

class _HistoryLink11bState extends State<HistoryLink11b> {
  late String link;
  late String id;
  late String pass;
