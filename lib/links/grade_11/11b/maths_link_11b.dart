...
class MathsLink11b extends StatefulWidget {
  const MathsLink11b({Key? key}) : super(key: key);

  @override
  _MathsLink11bState createState() => _MathsLink11bState();
}

class _MathsLink11bState extends State<MathsLink11b> {
  late String link;
  late String id;
  late String pass;
