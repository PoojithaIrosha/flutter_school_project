...
class EnglishLink11b extends StatefulWidget {
  const EnglishLink11b({Key? key}) : super(key: key);

  @override
  _EnglishLink11bState createState() => _EnglishLink11bState();
}

class _EnglishLink11bState extends State<EnglishLink11b> {
  late String link;
  late String id;
  late String pass;
