...
class ScienceLink11b extends StatefulWidget {
  const ScienceLink11b({Key? key}) : super(key: key);

  @override
  _ScienceLink11bState createState() => _ScienceLink11bState();
}

class _ScienceLink11bState extends State<ScienceLink11b> {
  late String link;
  late String id;
  late String pass;
