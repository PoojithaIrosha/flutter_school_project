...
class SinhalaLink11b extends StatefulWidget {
  const SinhalaLink11b({Key? key}) : super(key: key);

  @override
  _SinhalaLink11bState createState() => _SinhalaLink11bState();
}

class _SinhalaLink11bState extends State<SinhalaLink11b> {
  late String link;
  late String id;
  late String pass;
