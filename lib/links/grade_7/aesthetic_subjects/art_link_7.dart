...
class ArtLink7 extends StatefulWidget {
  const ArtLink7({Key? key}) : super(key: key);

  @override
  _ArtLink7State createState() => _ArtLink7State();
}

class _ArtLink7State extends State<ArtLink7> {
  late String link;
  late String id;
  late String pass;
