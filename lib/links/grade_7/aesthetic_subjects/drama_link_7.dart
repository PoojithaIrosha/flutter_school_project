...
class DramaLink7 extends StatefulWidget {
  const DramaLink7({Key? key}) : super(key: key);

  @override
  _DramaLink7State createState() => _DramaLink7State();
}

class _DramaLink7State extends State<DramaLink7> {
  late String link;
  late String id;
  late String pass;
