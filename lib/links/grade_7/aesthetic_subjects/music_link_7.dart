...
class MusicLink7 extends StatefulWidget {
  const MusicLink7({Key? key}) : super(key: key);

  @override
  _MusicLink7State createState() => _MusicLink7State();
}

class _MusicLink7State extends State<MusicLink7> {
  late String link;
  late String id;
  late String pass;
