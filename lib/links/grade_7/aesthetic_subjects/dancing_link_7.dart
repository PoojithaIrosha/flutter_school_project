...
class DancingLink7 extends StatefulWidget {
  const DancingLink7({Key? key}) : super(key: key);

  @override
  _DancingLink7State createState() => _DancingLink7State();
}

class _DancingLink7State extends State<DancingLink7> {
  late String link;
  late String id;
  late String pass;
