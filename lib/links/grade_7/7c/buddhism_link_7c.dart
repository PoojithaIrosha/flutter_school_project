...
class BuddhismLink7c extends StatefulWidget {
  const BuddhismLink7c({Key? key}) : super(key: key);

  @override
  _BuddhismLink7cState createState() => _BuddhismLink7cState();
}

class _BuddhismLink7cState extends State<BuddhismLink7c> {
  late String link;
  late String id;
  late String pass;
