...
class CivicLink7c extends StatefulWidget {
  const CivicLink7c({Key? key}) : super(key: key);

  @override
  _CivicLink7cState createState() => _CivicLink7cState();
}

class _CivicLink7cState extends State<CivicLink7c> {
  late String link;
  late String id;
  late String pass;
