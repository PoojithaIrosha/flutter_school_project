...
class SinhalaLink7c extends StatefulWidget {
  const SinhalaLink7c({Key? key}) : super(key: key);

  @override
  _SinhalaLink7cState createState() => _SinhalaLink7cState();
}

class _SinhalaLink7cState extends State<SinhalaLink7c> {
  late String link;
  late String id;
  late String pass;
