...
class MathsLink7c extends StatefulWidget {
  const MathsLink7c({Key? key}) : super(key: key);

  @override
  _MathsLink7cState createState() => _MathsLink7cState();
}

class _MathsLink7cState extends State<MathsLink7c> {
  late String link;
  late String id;
  late String pass;
