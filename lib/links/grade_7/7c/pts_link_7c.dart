...
class PtsLink7c extends StatefulWidget {
  const PtsLink7c({Key? key}) : super(key: key);

  @override
  _PtsLink7cState createState() => _PtsLink7cState();
}

class _PtsLink7cState extends State<PtsLink7c> {
  late String link;
  late String id;
  late String pass;
