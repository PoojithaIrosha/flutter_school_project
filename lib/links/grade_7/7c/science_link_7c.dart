...
class ScienceLink7c extends StatefulWidget {
  const ScienceLink7c({Key? key}) : super(key: key);

  @override
  _ScienceLink7cState createState() => _ScienceLink7cState();
}

class _ScienceLink7cState extends State<ScienceLink7c> {
  late String link;
  late String id;
  late String pass;
