...
class HealthLink7c extends StatefulWidget {
  const HealthLink7c({Key? key}) : super(key: key);

  @override
  _HealthLink7cState createState() => _HealthLink7cState();
}

class _HealthLink7cState extends State<HealthLink7c> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      // Change Here
                      "You have class on every Saturday from 6.00PM to 7.30PM",
                      style: TextStyle(
                          fontSize: 25,
                          fontFamily: 'Caveat',
