...
class GeoLink7c extends StatefulWidget {
  const GeoLink7c({Key? key}) : super(key: key);

  @override
  _GeoLink7cState createState() => _GeoLink7cState();
}

class _GeoLink7cState extends State<GeoLink7c> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 7C - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
