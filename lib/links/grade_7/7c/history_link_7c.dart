...
class HistoryLink7c extends StatefulWidget {
  const HistoryLink7c({Key? key}) : super(key: key);

  @override
  _HistoryLink7cState createState() => _HistoryLink7cState();
}

class _HistoryLink7cState extends State<HistoryLink7c> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      // Change Here
                      "You have class on every Wednesday from 6.00PM to 7.30PM",
                      style: TextStyle(
                          fontSize: 25,
                          fontFamily: 'Caveat',
