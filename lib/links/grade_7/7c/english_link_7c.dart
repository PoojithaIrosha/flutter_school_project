...
class EnglishLink7c extends StatefulWidget {
  const EnglishLink7c({Key? key}) : super(key: key);

  @override
  _EnglishLink7cState createState() => _EnglishLink7cState();
}

class _EnglishLink7cState extends State<EnglishLink7c> {
  late String link;
  late String id;
  late String pass;
