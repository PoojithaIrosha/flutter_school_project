...
class TamilLink7c extends StatefulWidget {
  const TamilLink7c({Key? key}) : super(key: key);

  @override
  _TamilLink7cState createState() => _TamilLink7cState();
}

class _TamilLink7cState extends State<TamilLink7c> {
  late String link;
  late String id;
  late String pass;
