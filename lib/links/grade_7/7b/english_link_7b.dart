...
class EnglishLink7b extends StatefulWidget {
  const EnglishLink7b({Key? key}) : super(key: key);

  @override
  _EnglishLink7bState createState() => _EnglishLink7bState();
}

class _EnglishLink7bState extends State<EnglishLink7b> {
  late String link;
  late String id;
  late String pass;
