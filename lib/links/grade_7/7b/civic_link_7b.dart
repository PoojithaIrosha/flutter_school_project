...
class CivicLink7b extends StatefulWidget {
  const CivicLink7b({Key? key}) : super(key: key);

  @override
  _CivicLink7bState createState() => _CivicLink7bState();
}

class _CivicLink7bState extends State<CivicLink7b> {
  late String link;
  late String id;
  late String pass;
