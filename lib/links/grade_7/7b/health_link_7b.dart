...
class HealthLink7b extends StatefulWidget {
  const HealthLink7b({Key? key}) : super(key: key);

  @override
  _HealthLink7bState createState() => _HealthLink7bState();
}

class _HealthLink7bState extends State<HealthLink7b> {
  late String link;
  late String id;
  late String pass;
