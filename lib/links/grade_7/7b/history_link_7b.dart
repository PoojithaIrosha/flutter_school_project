...
class HistoryLink7b extends StatefulWidget {
  const HistoryLink7b({Key? key}) : super(key: key);

  @override
  _HistoryLink7bState createState() => _HistoryLink7bState();
}

class _HistoryLink7bState extends State<HistoryLink7b> {
  late String link;
  late String id;
  late String pass;
