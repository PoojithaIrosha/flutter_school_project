...
class BuddhismLink7b extends StatefulWidget {
  const BuddhismLink7b({Key? key}) : super(key: key);

  @override
  _BuddhismLink7bState createState() => _BuddhismLink7bState();
}

class _BuddhismLink7bState extends State<BuddhismLink7b> {
  late String link;
  late String id;
  late String pass;
