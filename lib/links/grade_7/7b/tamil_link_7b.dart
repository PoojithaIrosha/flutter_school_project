...
class TamilLink7b extends StatefulWidget {
  const TamilLink7b({Key? key}) : super(key: key);

  @override
  _TamilLink7bState createState() => _TamilLink7bState();
}

class _TamilLink7bState extends State<TamilLink7b> {
  late String link;
  late String id;
  late String pass;
