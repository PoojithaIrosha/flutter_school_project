...
class PtsLink7b extends StatefulWidget {
  const PtsLink7b({Key? key}) : super(key: key);

  @override
  _PtsLink7bState createState() => _PtsLink7bState();
}

class _PtsLink7bState extends State<PtsLink7b> {
  late String link;
  late String id;
  late String pass;
