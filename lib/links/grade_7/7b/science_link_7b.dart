...
class ScienceLink7b extends StatefulWidget {
  const ScienceLink7b({Key? key}) : super(key: key);

  @override
  _ScienceLink7bState createState() => _ScienceLink7bState();
}

class _ScienceLink7bState extends State<ScienceLink7b> {
  late String link;
  late String id;
  late String pass;
