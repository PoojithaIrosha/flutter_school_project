...
class MathsLink7b extends StatefulWidget {
  const MathsLink7b({Key? key}) : super(key: key);

  @override
  _MathsLink7bState createState() => _MathsLink7bState();
}

class _MathsLink7bState extends State<MathsLink7b> {
  late String link;
  late String id;
  late String pass;
