...
class GeoLink7b extends StatefulWidget {
  const GeoLink7b({Key? key}) : super(key: key);

  @override
  _GeoLink7bState createState() => _GeoLink7bState();
}

class _GeoLink7bState extends State<GeoLink7b> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 7B - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
