...
class BuddhismLink7a extends StatefulWidget {
  const BuddhismLink7a({Key? key}) : super(key: key);

  @override
  _BuddhismLink7aState createState() => _BuddhismLink7aState();
}

class _BuddhismLink7aState extends State<BuddhismLink7a> {
  late String link;
  late String id;
  late String pass;
