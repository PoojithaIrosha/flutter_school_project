...
class TamilLink7a extends StatefulWidget {
  const TamilLink7a({Key? key}) : super(key: key);

  @override
  _TamilLink7aState createState() => _TamilLink7aState();
}

class _TamilLink7aState extends State<TamilLink7a> {
  late String link;
  late String id;
  late String pass;
