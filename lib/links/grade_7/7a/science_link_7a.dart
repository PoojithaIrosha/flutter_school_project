...
class ScienceLink7a extends StatefulWidget {
  const ScienceLink7a({Key? key}) : super(key: key);

  @override
  _ScienceLink7aState createState() => _ScienceLink7aState();
}

class _ScienceLink7aState extends State<ScienceLink7a> {
  late String link;
  late String id;
  late String pass;
