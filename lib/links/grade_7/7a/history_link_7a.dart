...
class HistoryLink7a extends StatefulWidget {
  const HistoryLink7a({Key? key}) : super(key: key);

  @override
  _HistoryLink7aState createState() => _HistoryLink7aState();
}

class _HistoryLink7aState extends State<HistoryLink7a> {
  late String link;
  late String id;
  late String pass;
