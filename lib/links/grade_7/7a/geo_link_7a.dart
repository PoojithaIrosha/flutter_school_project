...
class GeoLink7a extends StatefulWidget {
  const GeoLink7a({Key? key}) : super(key: key);

  @override
  _GeoLink7aState createState() => _GeoLink7aState();
}

class _GeoLink7aState extends State<GeoLink7a> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 7A - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
