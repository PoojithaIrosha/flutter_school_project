...
class EnglishLink7a extends StatefulWidget {
  const EnglishLink7a({Key? key}) : super(key: key);

  @override
  _EnglishLink7aState createState() => _EnglishLink7aState();
}

class _EnglishLink7aState extends State<EnglishLink7a> {
  late String link;
  late String id;
  late String pass;
