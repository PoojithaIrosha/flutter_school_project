...
class SinhalaLink7a extends StatefulWidget {
  const SinhalaLink7a({Key? key}) : super(key: key);

  @override
  _SinhalaLink7aState createState() => _SinhalaLink7aState();
}

class _SinhalaLink7aState extends State<SinhalaLink7a> {
  late String link;
  late String id;
  late String pass;
