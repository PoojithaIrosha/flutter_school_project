...
class CivicLink7a extends StatefulWidget {
  const CivicLink7a({Key? key}) : super(key: key);

  @override
  _CivicLink7aState createState() => _CivicLink7aState();
}

class _CivicLink7aState extends State<CivicLink7a> {
  late String link;
  late String id;
  late String pass;
