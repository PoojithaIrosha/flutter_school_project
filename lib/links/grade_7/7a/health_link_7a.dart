...
class HealthLink7a extends StatefulWidget {
  const HealthLink7a({Key? key}) : super(key: key);

  @override
  _HealthLink7aState createState() => _HealthLink7aState();
}

class _HealthLink7aState extends State<HealthLink7a> {
  late String link;
  late String id;
  late String pass;
