...
class PtsLink7a extends StatefulWidget {
  const PtsLink7a({Key? key}) : super(key: key);

  @override
  _PtsLink7aState createState() => _PtsLink7aState();
}

class _PtsLink7aState extends State<PtsLink7a> {
  late String link;
  late String id;
  late String pass;
