...
class MathsLink7a extends StatefulWidget {
  const MathsLink7a({Key? key}) : super(key: key);

  @override
  _MathsLink7aState createState() => _MathsLink7aState();
}

class _MathsLink7aState extends State<MathsLink7a> {
  late String link;
  late String id;
  late String pass;
