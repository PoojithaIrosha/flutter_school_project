...
class ArtLink10 extends StatefulWidget {
  const ArtLink10({Key? key}) : super(key: key);

  @override
  _ArtLink10State createState() => _ArtLink10State();
}

class _ArtLink10State extends State<ArtLink10> {
  late String link;
  late String id;
  late String pass;
