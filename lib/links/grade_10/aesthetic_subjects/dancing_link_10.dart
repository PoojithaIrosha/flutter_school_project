...
class DancingLink10 extends StatefulWidget {
  const DancingLink10({Key? key}) : super(key: key);

  @override
  _DancingLink10State createState() => _DancingLink10State();
}

class _DancingLink10State extends State<DancingLink10> {
  late String link;
  late String id;
  late String pass;
