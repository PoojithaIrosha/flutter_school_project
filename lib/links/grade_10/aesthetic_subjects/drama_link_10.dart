...
class DramaLink10 extends StatefulWidget {
  const DramaLink10({Key? key}) : super(key: key);

  @override
  _DramaLink10State createState() => _DramaLink10State();
}

class _DramaLink10State extends State<DramaLink10> {
  late String link;
  late String id;
  late String pass;
