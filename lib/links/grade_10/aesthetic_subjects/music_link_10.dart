...
class MusicLink10 extends StatefulWidget {
  const MusicLink10({Key? key}) : super(key: key);

  @override
  _MusicLink10State createState() => _MusicLink10State();
}

class _MusicLink10State extends State<MusicLink10> {
  late String link;
  late String id;
  late String pass;
