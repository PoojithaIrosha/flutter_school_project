...
class HealthLink10 extends StatefulWidget {
  const HealthLink10({Key? key}) : super(key: key);

  @override
  _HealthLink10State createState() => _HealthLink10State();
}

class _HealthLink10State extends State<HealthLink10> {
  late String link;
  late String id;
  late String pass;
