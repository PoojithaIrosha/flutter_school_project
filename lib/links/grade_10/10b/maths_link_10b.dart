...
class MathsLink10b extends StatefulWidget {
  const MathsLink10b({Key? key}) : super(key: key);

  @override
  _MathsLink10bState createState() => _MathsLink10bState();
}

class _MathsLink10bState extends State<MathsLink10b> {
  late String link;
  late String id;
  late String pass;
