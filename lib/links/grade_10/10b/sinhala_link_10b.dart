...
class SinhalaLink10b extends StatefulWidget {
  const SinhalaLink10b({Key? key}) : super(key: key);

  @override
  _SinhalaLink10bState createState() => _SinhalaLink10bState();
}

class _SinhalaLink10bState extends State<SinhalaLink10b> {
  late String link;
  late String id;
  late String pass;
