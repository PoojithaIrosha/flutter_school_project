...
class ScienceLink10b extends StatefulWidget {
  const ScienceLink10b({Key? key}) : super(key: key);

  @override
  _ScienceLink10bState createState() => _ScienceLink10bState();
}

class _ScienceLink10bState extends State<ScienceLink10b> {
  late String link;
  late String id;
  late String pass;
