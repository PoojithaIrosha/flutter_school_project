...
class BuddhismLink10b extends StatefulWidget {
  const BuddhismLink10b({Key? key}) : super(key: key);

  @override
  _BuddhismLink10bState createState() => _BuddhismLink10bState();
}

class _BuddhismLink10bState extends State<BuddhismLink10b> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 10B - Buddhism", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
