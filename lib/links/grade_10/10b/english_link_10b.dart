...
class EnglishLink10b extends StatefulWidget {
  const EnglishLink10b({Key? key}) : super(key: key);

  @override
  _EnglishLink10bState createState() => _EnglishLink10bState();
}

class _EnglishLink10bState extends State<EnglishLink10b> {
  late String link;
  late String id;
  late String pass;
