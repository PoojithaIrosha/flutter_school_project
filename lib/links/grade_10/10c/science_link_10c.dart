...
class ScienceLink10c extends StatefulWidget {
  const ScienceLink10c({Key? key}) : super(key: key);

  @override
  _ScienceLink10cState createState() => _ScienceLink10cState();
}

class _ScienceLink10cState extends State<ScienceLink10c> {
  late String link;
  late String id;
  late String pass;
