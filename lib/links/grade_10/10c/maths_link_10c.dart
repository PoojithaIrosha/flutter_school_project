...
class MathsLink10c extends StatefulWidget {
  const MathsLink10c({Key? key}) : super(key: key);

  @override
  _MathsLink10cState createState() => _MathsLink10cState();
}

class _MathsLink10cState extends State<MathsLink10c> {
  late String link;
  late String id;
  late String pass;
