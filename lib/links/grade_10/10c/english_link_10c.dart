...
class EnglishLink10c extends StatefulWidget {
  const EnglishLink10c({Key? key}) : super(key: key);

  @override
  _EnglishLink10cState createState() => _EnglishLink10cState();
}

class _EnglishLink10cState extends State<EnglishLink10c> {
  late String link;
  late String id;
  late String pass;
