...
class SinhalaLink10a extends StatefulWidget {
  const SinhalaLink10a({Key? key}) : super(key: key);

  @override
  _SinhalaLink10aState createState() => _SinhalaLink10aState();
}

class _SinhalaLink10aState extends State<SinhalaLink10a> {
  late String link;
  late String id;
  late String pass;
