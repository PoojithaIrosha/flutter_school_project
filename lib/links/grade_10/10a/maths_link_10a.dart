...
class MathsLink10a extends StatefulWidget {
  const MathsLink10a({Key? key}) : super(key: key);

  @override
  _MathsLink10aState createState() => _MathsLink10aState();
}

class _MathsLink10aState extends State<MathsLink10a> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      // Change Here
                      "You have class on every Tuesday from 6.00PM to 7.30APM",
                      style: TextStyle(
                          fontSize: 25,
                          fontFamily: 'Caveat',
