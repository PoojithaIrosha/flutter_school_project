...
class ScienceLink10a extends StatefulWidget {
  const ScienceLink10a({Key? key}) : super(key: key);

  @override
  _ScienceLink10aState createState() => _ScienceLink10aState();
}

class _ScienceLink10aState extends State<ScienceLink10a> {
  late String link;
  late String id;
  late String pass;
