...
class BuddhismLink10a extends StatefulWidget {
  const BuddhismLink10a({Key? key}) : super(key: key);

  @override
  _BuddhismLink10aState createState() => _BuddhismLink10aState();
}

class _BuddhismLink10aState extends State<BuddhismLink10a> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 10A - Buddhism", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
