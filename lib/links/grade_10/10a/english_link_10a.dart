...
class EnglishLink10a extends StatefulWidget {
  const EnglishLink10a({Key? key}) : super(key: key);

  @override
  _EnglishLink10aState createState() => _EnglishLink10aState();
}

class _EnglishLink10aState extends State<EnglishLink10a> {
  late String link;
  late String id;
  late String pass;
