...
class CommerceLink10 extends StatefulWidget {
  const CommerceLink10({Key? key}) : super(key: key);

  @override
  _CommerceLink10State createState() => _CommerceLink10State();
}

class _CommerceLink10State extends State<CommerceLink10> {
  late String link;
  late String id;
  late String pass;
