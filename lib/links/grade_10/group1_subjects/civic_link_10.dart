...
class CivicLink10 extends StatefulWidget {
  const CivicLink10({Key? key}) : super(key: key);

  @override
  _CivicLink10State createState() => _CivicLink10State();
}

class _CivicLink10State extends State<CivicLink10> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 10 - Civic Education", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
