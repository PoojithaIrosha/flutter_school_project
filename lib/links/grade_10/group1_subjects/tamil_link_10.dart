...
class TamilLink10 extends StatefulWidget {
  const TamilLink10({Key? key}) : super(key: key);

  @override
  _TamilLink10State createState() => _TamilLink10State();
}

class _TamilLink10State extends State<TamilLink10> {
  late String link;
  late String id;
  late String pass;
