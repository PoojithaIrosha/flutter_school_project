...
class GeoLink10 extends StatefulWidget {
  const GeoLink10({Key? key}) : super(key: key);

  @override
  _GeoLink10State createState() => _GeoLink10State();
}

class _GeoLink10State extends State<GeoLink10> {
  late String link;
  late String id;
  late String pass;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Grade 10 - Geography", // Change Here..
                      style: TextStyle(
                          fontSize: 45,
